    ...
    public partial class Ejercicio1 : Form
    {
        ...
        private void MostrarDatosAlumnos()
        {
            if (dt.Rows.Count > 0)
            {
                ...
                cmbSexoAlumno.Text = dt.Rows[posicion].ItemArray[4].ToString();
                txtLab1.Text = dt.Rows[posicion].ItemArray[5].ToString();
                txtLab2.Text = dt.Rows[posicion].ItemArray[6].ToString();
                txtParcial.Text = dt.Rows[posicion].ItemArray[7].ToString();
                txtPromedioAlumno.Text = dt.Rows[posicion].ItemArray[8].ToString();
