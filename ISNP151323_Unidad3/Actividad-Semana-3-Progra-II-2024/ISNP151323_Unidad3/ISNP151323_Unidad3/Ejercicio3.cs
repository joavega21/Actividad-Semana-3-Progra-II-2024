    ...
    public partial class Ejercicio3 : Form
    {
        ...
        private void MostrarDatosPaciente() {
            if (dt.Rows.Count > 0) {
                ...
                cmbVacuna1.Text = dt.Rows[posicion].ItemArray[3].ToString();
                cmbVacuna2.Text = dt.Rows[posicion].ItemArray[4].ToString();
                cmbVacuna3.Text = dt.Rows[posicion].ItemArray[5].ToString();
                cmbVacuna4.Text = dt.Rows[posicion].ItemArray[6].ToString();
